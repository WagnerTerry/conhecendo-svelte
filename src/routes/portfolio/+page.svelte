    ...
    <div class="container px-6 py-10 mx-auto">
        ...
        <section class="mt-8 space-y-8 lg:mt-12">
            ...
            <section class="lg:flex lg:items-center">
                <div class="lg:w-1/2 ">
                    <p class="text-lg tracking-wider text-blue-500 uppercase dark:text-blue-400 ">{title}</p>
                    <h2 class="mt-2 text-2xl font-semibold text-gray-800 capitalize dark:text-white">{category}</h2>
                </div>
